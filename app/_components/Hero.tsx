...
export default function Hero() {
  return (
    <Section className="flex flex-col gap-2 lg:gap-4 mt-32 md:mt-32 lg:mt-44">
      ...
      >
        <div
          className="relative aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#de1414] to-[#2f0df2] opacity-30 sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <p className="text-[15px] leading-7">
        I{" "}
        <Code>
          <CustomIcon className="inline" name="code" size={16} /> build
        </Code>{" "}
        modern web applications with{" "}
        <Code>
          <CustomIcon className="inline" name="reactjs" size={16} /> React.js
        </Code>{" "}
        &{" "}
        <Code>
          <CustomIcon className="inline" name="nextjs" size={14.5} /> Next.js
        </Code>
      </p>
      ...
      >
        <div
          className="relative left-[calc(10%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#22c55e] to-[#059669] opacity-30 sm:left-[calc(10%+36rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
              "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
          }}
      ...
      >
        <div
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#de1414] to-[#2f0df2] t opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
              "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
          }}
